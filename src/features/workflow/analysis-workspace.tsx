...
export function AnalysisWorkspace() {
  const [step, setStep] = useState<"import" | "setup">("import");
  ...
  return <main className="mx-auto min-h-screen w-full max-w-[1280px] px-4 py-5 sm:px-8">
    ...
    <div hidden={step !== "setup"}><FinancialSetupWizard source={source} /></div>
    <footer className="mt-10 border-t border-[var(--line)] py-5 text-xs text-[var(--muted)]">Phase 3 review checkpoint · Financial setup only. No actual or estimated profit is calculated yet.</footer>
  </main>;
}
